...
<template>
  <div class="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col">
    ...
    <!-- System Banner -->
    <div class="h-8 flex items-center justify-between px-4 bg-slate-100 dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 flex-shrink-0">
    ...
    <!-- Top Bar -->
    <header class="h-14 flex items-center px-4 gap-3 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 z-40 flex-shrink-0">
      <!-- Rail toggle -->
      <button
        type="button"
      ...
      <button
        type="button"
        class="text-xs text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 font-medium px-2 py-1 rounded transition-colors"
        @click="exitToWeb"
      >
        Web
      </button>
    ...
    <div class="flex flex-1 overflow-hidden">
      ...
      >
        <nav class="flex flex-col items-center pt-3 gap-1 w-14">
          ...
          >
            <div
              class="w-10 h-10 flex items-center justify-center rounded-xl opacity-30 cursor-not-allowed"
              :title="item.label"
            >
    ...
    <!-- Mode toggle: fixed lower-right, next to context helper -->
    <div class="fixed bottom-4 right-20 z-[60] pointer-events-auto">
      <UButton
