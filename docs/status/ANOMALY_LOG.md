...
| 2026-03-11 | CV | C230 | Cedillo, Jonathan — unit changed C330→C230 (03-11, −$206 rent), start date moved 04-01→03-24 (03-12). Three changes in 2 days (unit, rent, start date). CV manager must confirm all changes are intentional and final. | WATCHING | 2026-03-14 |
| 2026-03-12 | WO | 464-E | MakeReady overdue Day 12 (03-14) — Sanchez Calixto is an **internal WO transfer** currently at 458-C. Vacates 458-C 03-15 (Saturday). Starts 464-E 03-16 (Monday). No WO manager action in 12 consecutive runs. Move-in is physically TODAY (03-16). EMERGENCY. | WATCHING | 2026-03-14 |
| 2026-03-12 | OB | S054 | Sandoval, America — lease_start_date 2026-03-15 (Sunday, now passed). MakeReady ready=2026-03-28 (13 days after start). Day 3 unresolved. Start date is now in the past. If unresolved in 03-16 run, escalate to FATAL. | WATCHING | 2026-03-14 |
| 2026-03-12 | OB | S150, S170 | MakeReady deferral pattern — S150 date pushed to 2026-04-22 (+46 days); S170 pushed to 2026-03-18 (+6 days). OB MakeReady not present in 03-14 batch — cannot verify today. S170 ready 03-18 — if not cleared by 03-18, new overdue flag imminent. OB manager should confirm these are legitimate timeline estimates. | WATCHING | 2026-03-13 |
| 2026-03-11 | SB | 2025 | Hong, Jonathan — start date corrected 2026-02-19 → 2026-03-23 on 03-12. Simultaneously rent changed $1,578 → $1,478 (−$100). Start date fix appears intentional; rent change requires SB manager confirmation. | WATCHING | 2026-03-14 |
| 2026-03-13 | SB | Unknown | SB silent drop pattern — 3 drops in 4 days (03-10, 03-11, 03-13). Not strictly consecutive but persistent. No drop on 03-14 — pattern paused. Monitor 03-16. | WATCHING | 2026-03-13 |
| 2026-03-13 | ALL | — | Work Orders showing 0 open across all 5 properties. Was 79+ on 03-12. Now Day 2 (03-14). No WO processing output in 03-14 console — supports file-exclusion hypothesis. Investigate before 03-16 run. | WATCHING | 2026-03-14 |
| 2026-03-13 | CV | C213 | Taub, Timothy — lease_start_date 2026-03-12. Still processing as Applicant in 03-14 run (Day 3). Saturday — Yardi won't process until Monday. If still Applicant in 03-16 run (Day 5), flag for CV manager immediately. | WATCHING | 2026-03-14 |
...
|---|---|---|---|
| 2026-02-01 | CV | All vacant units | AIRM revenue management tool produces $1–$4 micro-decrements daily on CV vacant units. This is automated repricing, not a bug. All other properties use manual repricing. |
...
| Date Escalated | Property | Unit(s) | Description | First Seen | Last Seen |
|---|---|---|---|---|---|
| 2026-03-14 | RS | Unknown | RS silent drops — 4 drops across 3 consecutive days (03-12: 1→Past, 03-13: 1→Canceled, 03-14: 2→Past). Threshold for RECURRING (3+ consecutive days) met. Unit identities unknown — run identity query Monday. Determine if same unit repeats (loop) or distinct vacates (normal pattern). | 2026-03-12 | 2026-03-14 |
...
| 2026-03-12 | 2026-03-14 | OB | S139/Avalos MakeReady — Avalos starts 03-14 (today). Confirmed absent from OB application queue in 03-14 run. MakeReady cleared. |
