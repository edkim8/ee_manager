-- Migration: Create View for Delinquent Residents Table
-- Date: 2026-02-09
-- Description: Provides a joined view for all delinquent residents with resident, unit, and building context.
